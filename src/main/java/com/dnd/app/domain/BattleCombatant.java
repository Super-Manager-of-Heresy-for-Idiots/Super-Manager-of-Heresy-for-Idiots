...
public class BattleCombatant {
    ...
    /**
     * Устойчивое состояние полёта (фаза 2.13): существо в воздухе. НЕ сбрасывается в начале хода (в
     * отличие от ходовых состояний 2.7) — остаётся в полёте между ходами. Индикатор/анимация — на фронте.
     */
