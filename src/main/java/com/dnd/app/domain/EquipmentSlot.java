...
/**
 * Класс EquipmentSlot описывает доменную модель, которая хранит состояние и инварианты игровой бизнес-логики.
...
@AllArgsConstructor
@Builder
public class EquipmentSlot implements DictionaryEntry {
