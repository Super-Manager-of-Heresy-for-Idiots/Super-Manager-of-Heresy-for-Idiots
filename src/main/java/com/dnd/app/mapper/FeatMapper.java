...
public class FeatMapper {
    ...
    public FeatDetailResponse toDetail(Feat f, String lang) {
        return FeatDetailResponse.builder()
                ...
                .packageId(com.dnd.app.util.HomebrewOrigin.id(f.getHomebrew()))
                .source(com.dnd.app.util.HomebrewOrigin.source(f.getHomebrew()))
                .homebrewTitle(com.dnd.app.util.HomebrewOrigin.title(f.getHomebrew()))
