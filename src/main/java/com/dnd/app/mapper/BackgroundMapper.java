...
public class BackgroundMapper {
    ...
    public BackgroundDetailResponse toDetail(Background b, String lang) {
        return BackgroundDetailResponse.builder()
                ...
                .url(b.getUrl())
                .packageId(com.dnd.app.util.HomebrewOrigin.id(b.getHomebrew()))
                .source(com.dnd.app.util.HomebrewOrigin.source(b.getHomebrew()))
                .homebrewTitle(com.dnd.app.util.HomebrewOrigin.title(b.getHomebrew()))
